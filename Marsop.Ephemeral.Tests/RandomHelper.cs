...
public class RandomHelper
{
    ...
    /// </summary>
    public DateTimeOffset GetRandomDateTimeOffset()
    {
        var start = new DateTimeOffset(1995, 1, 1, 0, 0, 0, TimeSpan.Zero);
        var range = (DateTimeOffset.UtcNow - start).Days;
    ...
    public IInterval<DateTimeOffset, TimeSpan> GetInterval(DateTimeOffset startDate, DateTimeOffset? endDate = null, bool? startIncluded = null, bool? endIncluded = null)
    {
        ...
        return new StandardInterval(startDate, end, startIncludedBool, endIncludedBool);
    }
